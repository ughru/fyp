            ...
            <View style={styles.container3}>
                {resource && (
                    <View style={{ top: 90, left: 20 }}>
                        ...
                        <Text style={[styles.titleNote, { marginBottom: 20 }]}>Written by: {resource.specialistName}</Text>
                        ...
                        <View style={{ marginBottom: 20 }}>
                            <View style={{ flexDirection: 'row', flexWrap: 'wrap' }}>
                                {resource.status && resource.status.map((status, index) => (
                                    <Pressable key={index} style={[styles.button9, { marginHorizontal: 2, marginBottom: 10 }]}>
                                        <Text>{status}</Text>
                                    </Pressable>
                                ))}
                            </View>
                        ...
                        <View style={[styles.container3, { marginBottom: 20 }]}>
                            <ScrollView contentContainerStyle={{marginRight: 40}}>
